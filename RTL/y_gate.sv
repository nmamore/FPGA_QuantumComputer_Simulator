/*
* @file y_gate.sv
* @brief Inverts and changes phase of input state vector
...
//Phase is also changed
assign alpha_re_o = beta_im_i;
assign alpha_im_o = ~beta_re_i + 1'b1;
assign beta_re_o  = ~alpha_im_i + 1'b1;
assign beta_im_o  = alpha_re_i;
